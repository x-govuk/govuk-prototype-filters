...
function govukDate(string, kwargs) {
  ...
  if (typeof kwargs === 'string') {
    ...
    console.warn(
      `Passing 'truncate' to govukDate is deprecated. Use the truncate option instead. See https://x-govuk.org/govuk-prototype-filters/date/#govukdate`
    )
  }
...
function govukDateTime(string, kwargs) {
  ...
  if (typeof kwargs === 'string') {
    ...
    options.truncate = kwargs === 'truncate'
    console.warn(
      `Passing 'on' to govukDateTime is deprecated. Use the timeFirst option instead. See https://x-govuk.org/govuk-prototype-filters/date/#govukdatetime`
    )
  }
...
function monthName(number, kwargs) {
  ...
  if (typeof kwargs === 'string') {
    options.truncate = kwargs === 'truncate'
    console.warn(
      `Passing 'truncate' to monthName is deprecated. Use the truncate option instead. See https://x-govuk.org/govuk-prototype-filters/date/#monthname`
    )
  }
