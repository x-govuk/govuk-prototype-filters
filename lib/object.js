...
/**
 * Check value is the language type of `Object`
 * @example isObject({country: 'england'}) // true
 * @example isObject(['england', 'scotland', 'wales']) // true
 * @example isObject('great britain') // false
...
/**
 * Convert object into an array, using key name as value for id.
 * @example
 * objectToArray({
